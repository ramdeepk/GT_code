...
def seeingRed(pic): #15
    for pix in getPixels(pic):
        setRed(pix, 255)

    show(pic)
    savePicture(pic, "redView.jpg")


def fadeToBlack(pic1, pic2, pic3, pic4):#35
...
def greenWhiteScreen(pic1, pic2, pic3, pic4, bkcg): #50
    picList = [pic1, pic2, pic3, pic4]
    for pic in picList:
    ...
    savePicture(picList, "greenWhiteScreen.gif")
